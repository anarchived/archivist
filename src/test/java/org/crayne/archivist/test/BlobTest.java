...
public class BlobTest {
    ...
    public void blobMergeTest() {
        final Region region1 = new Region(2, 3, World.OVERWORLD, Path.of("region1"));
        final Region region2 = new Region(2, 4, World.OVERWORLD, Path.of("region2"));
        final Blob blob1 = new Blob(Set.of(region1, region2), World.OVERWORLD);

        final Region region3 = new Region(2, 4, World.OVERWORLD, Path.of("region3"));
        final Blob blob2 = new Blob(Set.of(region3), World.OVERWORLD);

        final Region region4 = new Region(-2, 1, World.NETHER, Path.of("region4"));
        final Blob blob3 = new Blob(Set.of(region4), World.NETHER);

        final Region region5 = new Region(-2, 1, World.NETHER, Path.of("region5"));
        final Region region6 = new Region(-2, 2, World.NETHER, Path.of("region6"));
        final Blob blob4 = new Blob(Set.of(region5, region6), World.NETHER);
        ...
        final BlobWorld overworldBlobDim = blobField.blobWorlds().get(World.OVERWORLD);
        final BlobWorld netherBlobDim = blobField.blobWorlds().get(World.NETHER);
